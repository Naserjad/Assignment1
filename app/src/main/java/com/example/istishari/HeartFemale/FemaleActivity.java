    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdapterView.OnItemClickListener itemClickListener=new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(position==0){
                    Intent intent =new Intent(FemaleActivity.this, RamallahFemaleActivites.class);
                    startActivity(intent);
                }
                if(position==1){
                    Intent intent =new Intent(FemaleActivity.this, NablusFemaleActivity.class);
                   startActivity(intent);
                }
                if(position==2){
                    Intent intent =new Intent(FemaleActivity.this, JerusalemFemaleActivity.class);
                    startActivity(intent);
                }
